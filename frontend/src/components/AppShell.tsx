      ...
      <div className="flex min-h-screen">
        <aside className="hidden w-64 flex-col gap-6 bg-white px-6 py-8 shadow-card lg:flex">
          ...
          <div className="mt-auto rounded-2xl bg-slate-100 p-4 text-sm">
            ...
            <button
              className="mt-3 w-full rounded-lg bg-rose px-3 py-2 text-xs font-semibold text-white"
              onClick={() => logout()}
            >
              Logout
            </button>
        ...
        <main className="flex-1 px-4 py-6 lg:px-8">
          <header className="mb-6 flex items-center justify-between gap-3 lg:hidden">
            ...
            <button
              className="rounded-lg bg-rose px-3 py-2 text-xs font-semibold text-white"
              onClick={() => logout()}
            >
              Logout
            </button>
